...
// This will print the bar graph identical to our original table.
...
// An example would be Azusa, we use a red code, so we would use "1" for red.
...
public class CarbonMonoxideMethod {
